...
U 1 1 5FD15458
P 8850 4050
F 0 "D4" V 8889 3933 50  0000 R CNN
F 1 "LED green" V 8798 3933 50  0000 R CNN
F 2 "LEDs:LED_0603" H 8850 4050 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/1811101510_Everlight-Elec-19-217-GHC-YR1S2-3T_C72043.pdf" H 8850 4050 50  0001 C CNN
F 4 "C72043" V 8850 4050 50  0001 C CNN "LCSC"
	1    8850 4050
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5FD15E2D
P 10050 4050
F 0 "D6" V 10089 3933 50  0000 R CNN
F 1 "LED white" V 9998 3933 50  0000 R CNN
F 2 "LEDs:LED_0603" H 10050 4050 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/1809041711_Hubei-KENTO-Elec-C2290_C2290.pdf" H 10050 4050 50  0001 C CNN
F 4 "C2290" V 10050 4050 50  0001 C CNN "LCSC"
	1    10050 4050
	0    -1   -1   0   
$EndComp
$Comp
...
F 1 "180R" H 8920 4305 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" V 8780 4350 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/Uniroyal-Elec-0603WAF1800T5E_C22828.pdf" H 8850 4350 50  0001 C CNN
F 4 "C22828" H 8850 4350 50  0001 C CNN "LCSC"
	1    8850 4350
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FD16C0D
P 10050 4350
F 0 "R8" H 10120 4396 50  0000 L CNN
F 1 "130R" H 10120 4305 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" V 9980 4350 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/Uniroyal-Elec-0603WAF1300T5E_C22796.pdf" H 10050 4350 50  0001 C CNN
F 4 "C22796" H 10050 4350 50  0001 C CNN "LCSC"
	1    10050 4350
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5FD17B33
P 8850 4500
F 0 "#PWR0108" H 8850 4250 50  0001 C CNN
...
U 1 1 5FD1944E
P 9450 4050
F 0 "D5" V 9489 3933 50  0000 R CNN
F 1 "LED blue" V 9398 3933 50  0000 R CNN
F 2 "LEDs:LED_0603" H 9450 4050 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/1811101510_Everlight-Elec-19-217-BHC-ZL1M2RY-3T_C72041.pdf" H 9450 4050 50  0001 C CNN
F 4 "C72041" V 9450 4050 50  0001 C CNN "LCSC"
	1    9450 4050
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5FD1AB1A
P 9450 4350
F 0 "R7" H 9520 4396 50  0000 L CNN
F 1 "220R" H 9520 4305 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" V 9380 4350 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/Uniroyal-Elec-0603WAF2200T5E_C22962.pdf" H 9450 4350 50  0001 C CNN
F 4 "C22962" H 9450 4350 50  0001 C CNN "LCSC"
	1    9450 4350
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FD35D5D
P 8300 3650
F 0 "R12" H 8370 3696 50  0000 L CNN
F 1 "220R" H 8370 3605 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" V 8230 3650 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/Uniroyal-Elec-0603WAF2200T5E_C22962.pdf" H 8300 3650 50  0001 C CNN
F 4 "C22962" H 8300 3650 50  0001 C CNN "LCSC"
	1    8300 3650
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 5FD372D9
P 8750 3450
F 0 "#PWR0120" H 8750 3300 50  0001 C CNN
...
F 0 "Q2" H 8841 3696 50  0000 L CNN
F 1 "BC817" H 8841 3605 50  0000 L CNN
F 2 "TO_SOT_Packages_SMD:SOT-23" H 8850 3575 50  0001 L CIN
F 3 "https://www.onsemi.com/pub/Collateral/BC818-D.pdf" H 8650 3650 50  0001 L CNN
	1    8650 3650
	1    0    0    -1  
$EndComp
Wire Wire Line
...
$EndSheet
$Sheet
S 8600 1300 900  1450
U 600A4AF3
F0 "SheetALU" 50
F1 "alu.sch" 50
F2 "IN_A0" I L 8600 1400 50 
F3 "IN_B0" I L 8600 2300 50 
F4 "IN_A1" I L 8600 1500 50 
F5 "IN_A2" I L 8600 1600 50 
F6 "IN_A3" I L 8600 1700 50 
F7 "IN_B1" I L 8600 2400 50 
F8 "IN_B2" I L 8600 2500 50 
F9 "IN_B3" I L 8600 2600 50 
F10 "IN_OP0" I L 8600 1900 50 
F11 "IN_OP1" I L 8600 2000 50 
F12 "OUT_Y0" O R 9500 1550 50 
F13 "OUT_Y1" O R 9500 1650 50 
F14 "OUT_Y2" O R 9500 1750 50 
F15 "OUT_Y3" O R 9500 1850 50 
F16 "OUT_OF" O R 9500 2250 50 
F17 "OUT_NF" O R 9500 2350 50 
F18 "OUT_ZF" O R 9500 2450 50 
$EndSheet
$Sheet
S 9850 1450 500  1100
U 60318070
F0 "SheetOutput" 50
F1 "output.sch" 50
F2 "IN_Y0" I L 9850 1550 50 
F3 "IN_Y1" I L 9850 1650 50 
F4 "IN_Y2" I L 9850 1750 50 
F5 "IN_Y3" I L 9850 1850 50 
F6 "IN_OF" I L 9850 2250 50 
F7 "IN_NF" I L 9850 2350 50 
F8 "IN_ZF" I L 9850 2450 50 
$EndSheet
Wire Wire Line
	9500 1550 9850 1550
Wire Wire Line
...
Wire Wire Line
	9850 2450 9500 2450
$Sheet
S 7600 1350 650  1350
U 60342E90
F0 "SheetInput" 50
F1 "input.sch" 50
F2 "OUT_A0" O R 8250 1400 50 
F3 "OUT_A1" O R 8250 1500 50 
F4 "OUT_A2" O R 8250 1600 50 
F5 "OUT_A3" O R 8250 1700 50 
F6 "OUT_OP0" O R 8250 1900 50 
F7 "OUT_OP1" O R 8250 2000 50 
F8 "OUT_B0" O R 8250 2300 50 
F9 "OUT_B1" O R 8250 2400 50 
F10 "OUT_B2" O R 8250 2500 50 
F11 "OUT_B3" O R 8250 2600 50 
$EndSheet
Wire Wire Line
	8250 1400 8600 1400
Wire Wire Line
